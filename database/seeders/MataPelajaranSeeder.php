...
class MataPelajaranSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $mapels = [
            ...
            ['kelompok' => 'Muatan Nasional', 'nama' => 'Bahasa Inggris', 'urutan' => 7],
            ['kelompok' => 'Muatan Kewilayahan', 'nama' => 'Seni Budaya dan Keterampilan', 'urutan' => 8],
            ['kelompok' => 'Muatan Kewilayahan', 'nama' => 'Pendidikan Jasmani, Olahraga, dan Kesehatan', 'urutan' => 9],
            ['kelompok' => 'Muatan Kewilayahan', 'nama' => 'Prakarya', 'urutan' => 10],
            ['kelompok' => 'Muatan Lokal', 'nama' => 'Kemuhammadiyahan', 'urutan' => 11],
            ['kelompok' => 'Muatan Lokal', 'nama' => 'Bahasa Arab', 'urutan' => 12],
            ['kelompok' => 'Muatan Lokal', 'nama' => 'Bahasa Lampung', 'urutan' => 13],
        ];
