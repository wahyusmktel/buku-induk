        ...
        <aside :class="sidebarOpen ? 'translate-x-0 lg:ml-0' : '-translate-x-full lg:-ml-64'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-slate-200 transition-all duration-300 lg:static flex flex-col h-full shadow-xl lg:shadow-none shrink-0">
            ...
            <div class="p-4 border-t border-slate-100 shrink-0 bg-slate-50/50">
                <form action="{{ route('logout') }}" method="POST" class="w-full m-0 p-0">
                    @csrf
                    <button type="submit" class="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-rose-500 hover:bg-rose-50 hover:text-rose-600 font-semibold transition-colors w-full border border-rose-100 hover:border-rose-200 cursor-pointer">
                ...
                <div class="flex items-center gap-3 sm:gap-5">
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" 
                            ...
                            <a href="#" class="flex items-center gap-2 px-4 py-2.5 text-slate-600 hover:bg-indigo-50 hover:text-indigo-700 font-medium transition-colors">
