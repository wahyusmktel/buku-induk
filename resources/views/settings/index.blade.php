...
@section('breadcrumb')
    ...
    <span class="text-slate-800 font-semibold">Sistem Umum</span>
@endsection
    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="kepsek_nama" class="block text-sm font-semibold text-slate-700 mb-1.5">Nama Terang Kepala Sekolah</label>
                    <input type="text" id="kepsek_nama" name="kepsek_nama" 
                           value="{{ old('kepsek_nama', $settings['kepsek_nama'] ?? '') }}"
                           class="w-full rounded-lg border-slate-300 focus:border-sky-500 focus:ring-sky-500/20 shadow-sm text-sm"
                ...
                <div>
                    <label for="kepsek_nip" class="block text-sm font-semibold text-slate-700 mb-1.5">NIP / NIK Kepala Sekolah</label>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="buku_induk_kota" class="block text-sm font-semibold text-slate-700 mb-1.5">Kota / Tempat Penerbitan</label>
                ...
                <div>
                    <label for="buku_induk_tanggal" class="block text-sm font-semibold text-slate-700 mb-1.5">Format / Tanggal Default (Opsional)</label>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 relative group">
                    <label class="block text-sm font-bold text-slate-700 mb-3 border-b border-slate-200 pb-2">Kop Surat Sekolah</label>
                ...
                {{-- Logo Sekolah --}}
                <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 relative group">
                    <label class="block text-sm font-bold text-slate-700 mb-3 border-b border-slate-200 pb-2">Logo Sekolah</label>
        ...
        <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-200 mt-10">
            <button type="reset" onclick="window.location.reload()" class="px-5 py-2.5 text-sm font-semibold text-slate-600 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 focus:ring-4 focus:ring-slate-100 transition-all">
                Batal
            </button>
            <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-sky-600 border border-transparent rounded-xl hover:bg-sky-700 focus:ring-4 focus:ring-sky-200 shadow-sm transition-all flex items-center gap-2">
