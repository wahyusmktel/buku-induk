                    ...
                    <div class="flex-1 space-y-6 min-w-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div x-show="paperSize === 'custom'" x-cloak class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-[0.65rem] font-bold text-slate-400 uppercase mb-1">Lebar (mm)</label>
                                    <input type="number" step="0.1" name="paper_width" x-model.number="customW" :disabled="paperSize !== 'custom'" class="w-full px-3 py-2 text-sm rounded-xl border-slate-200 bg-slate-50/50 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all font-bold text-slate-700 text-center shadow-inner disabled:bg-slate-100 disabled:opacity-60">
                                </div>
                                <div>
                                    <label class="block text-[0.65rem] font-bold text-slate-400 uppercase mb-1">Tinggi (mm)</label>
                                    <input type="number" step="0.1" name="paper_height" x-model.number="customH" :disabled="paperSize !== 'custom'" class="w-full px-3 py-2 text-sm rounded-xl border-slate-200 bg-slate-50/50 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all font-bold text-slate-700 text-center shadow-inner disabled:bg-slate-100 disabled:opacity-60">
                                </div>
                            </div>
                        </div>
