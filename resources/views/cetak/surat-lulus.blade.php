...
<head>
    ...
    <title>Surat Keterangan Lulus - {{ $siswa->nama }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @media print {
            body { margin: 0; }
            .page { margin: 0; padding: 15mm 20mm 15mm 25mm; }
...
<body>
    ...
    <div class="page">
        ...
        @php
            ...
            $tahunLulus  = $bukuInduk->tgl_lulus
                ? \Carbon\Carbon::parse($bukuInduk->tgl_lulus)->translatedFormat('d F Y')
        ...
        <table class="tabel-data">
            ...
            @endif
            @if($bukuInduk->tanggal_ijazah)
            <tr>
                <td>Tanggal Ijazah</td>
                <td>:</td>
                <td>{{ \Carbon\Carbon::parse($bukuInduk->tanggal_ijazah)->translatedFormat('d F Y') }}</td>
            </tr>
            @endif
            @if($bukuInduk->lanjut_ke)
            <tr>
                <td>Melanjutkan Ke</td>
                <td>:</td>
                <td>{{ $bukuInduk->lanjut_ke }}</td>
            </tr>
            @endif
        </table>

        <p class="paragraf">
            telah dinyatakan <strong>LULUS</strong> dari {{ $jenjang }} {{ $namaSekolah }}
