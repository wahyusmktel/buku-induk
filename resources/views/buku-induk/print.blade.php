...
<body>
    ...
    <div class="content-wrapper">
        ...
        {{-- ===== VI. PRESTASI BELAJAR (halaman baru placeholder) ===== --}}
        <div class="page-break-before section-block" style="border: 2px dashed #9ca3af; padding: 30px; text-align: center; margin-bottom: 20px; border-radius: 8px;">
            <p class="section-title" style="margin-top: 0; border-bottom: none; font-size: 14pt; padding-bottom: 0;">VI. PRESTASI BELAJAR</p>
            <p style="font-size: 10pt; color: #4b5563; margin-top: 5px;">
                Catatan nilai akademik secara lengkap dilampirkan pada dokumen terpisah <strong>(Format Landscape)</strong>.
            </p>
        </div>
