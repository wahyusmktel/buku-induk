        ...
        <form action="{{ route('buku-induk.update', $siswa->nisn) }}" method="POST" enctype="multipart/form-data" class="p-8" @submit="validateWali($event)">
            ...
            <div x-show="section === 'registrasi'" x-transition>
                <div class="border-2 border-dashed border-slate-300 rounded-2xl p-8 mb-6 relative bg-slate-50/50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="space-y-1.5"><label class="text-xs font-black text-slate-500 uppercase">1. Tanggal Lulus</label><input type="date" name="tamat[tgl_lulus]" value="{{ old('tamat.tgl_lulus', $bukuInduk->tgl_lulus?->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 font-bold text-slate-700"></div>
                        ...
                        <div class="space-y-1.5"><label class="text-xs font-black text-slate-500 uppercase">3. Tanggal Ijazah</label><input type="date" name="tamat[tanggal_ijazah]" value="{{ old('tamat.tanggal_ijazah', $bukuInduk->tanggal_ijazah?->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 font-bold text-slate-700"></div>
